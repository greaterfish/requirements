...
| 目标   | 在第一版应用上线之后的3个月内，绑定子女用户的老年用户超过80%。在第一版应用上线之后的3个月内，平台会员数超过总用户数5%。 |
...
SF1：根据用户历史操作数据，对用户进行个性化内容推荐，包括兴趣小组、兴趣课程、兴趣交流帖、娱乐内容。
...
SF5：兴趣板块-教学区中，兴趣课程提供简洁的购买、管理流程、齐全的售后。
...
| :------------ | ------------------------------------------------------------ |
| ID            | P1                                                           |
| 解决方案1描述 | 系统提供易懂的互联网常见app使用教程，可以帮助老年人用户入门使用。 |
...
| :------------ | ------------------------------------------------------------ |
| ID            | P1                                                           |
| 解决方案2描述 | 系统提供人工客服接口，用户如果在app使用上遇到问题，可以通过咨询人工客服进行解决。 |
...
| :------------ | ------------------------------------------------------------ |
| ID            | P2                                                           |
| 解决方案1描述 | 找出一些常见问题及其对应解决方案构建智能客服，系统以问答方式提供基础的用户app使用问题。 |
...
| :------------ | ------------------------------------------------------------ |
| ID            | P2                                                           |
| 解决方案2描述 | 根据知识图谱构建智能客服，以对话方式较为深入的回答用户app使用问题。 |
...
| :------------ | ---------------------------------------------------- |
| ID            | P2                                                   |
| 解决方案3描述 | 系统为客服人员提供一系列适用于老年人的话术快捷输入。 |
...
| :------------ | ------------------------------------------------------------ |
| ID            | P3                                                           |
| 解决方案2描述 | 系统制定相应的激励策略，鼓励用户进行兴趣课程创作             |
...
| :------------ | :----------------------------------------------------------- |
| ID            | P4                                                           |
| 解决方案1描述 | 系统签约一部分优质的兴趣课程提供者，给他们提供稳定的签约收入； |
...
| :------------ | ------------------------------------------------------------ |
| ID            | P4                                                           |
| 解决方案2描述 | 系统分析统计视频播放等信息，筛选出优质视频，给优质视频更多的流量。 |
...
| :------------ | ------------------------------------------------------------ |
| ID            | P5                                                           |
| 解决方案1描述 | 系统给予教程购买补贴（优惠机制），吸引用户购买教程。平台对部分教程推出试学功能，试学1节课后再选择是否购买. |
...
| :------------ | ------------------------------------------------------------ |
| ID            | P6                                                           |
| 解决方案2描述 | 系统根据用户数据分析用户的兴趣喜好，给其推荐可能感兴趣的兴趣小组。 |
| 业务优势      | 个性化的推荐兴趣小组                                         |
| 代价          | 这个功能的实现难度大，在技术方面需要巨大的研发投入           |
...
| :------------ | ---------------------------------------------------- |
| ID            | P7                                                   |
| 解决方案1描述 | 系统根据用户的兴趣，给用户推荐可能感兴趣的交流内容。 |
| 业务优势      | 个性化的推荐内容，针对性更高。                       |
| 代价          | 这个功能的实现难度大，在技术方面需要巨大的研发投入   |
...
| :------------ | ------------------------------------------------------------ |
| ID            | P8                                                           |
| 解决方案1描述 | 系统定义一些诈骗相关的关键词，匹配到了就进行提醒。到一定阈值进行人工干涉。 |
...
| :------------ | ------------------------------------------------------- |
| ID            | P8                                                      |
| 解决方案2描述 | 系统提供NLP诈骗消息识别模型，用来预测消息是否是诈骗消息 |
| 业务优势      | 诈骗消息检测正确高                                      |
| 代价          | 模型开发训练成本高，运维成本高                          |
...
| :------------ | -------------------------------------------------------- |
| ID            | P9                                                       |
| 解决方案1描述 | 系统在子女端提供主动与老人交互的功能，如购买兴趣课程等。 |
...
| :------------ | ---------------------------------------------- |
| ID            | P10                                            |
| 解决方案1描述 | 系统提供渠道礼包，给线下接入的用户提供专属礼包 |
...
| :------------ | -------------------------------------------------------- |
| ID            | P11                                                      |
| 解决方案1描述 | 系统提供亲子帐号认证绑定功能，子女用户可以为父母用户付费 |
...
| SF5  | P3、P5     | 兴趣板块-教学区中，兴趣课程提供简洁的购买、管理流程、齐全的售后。 |
...
|      |            |                                                              |
|      |            |                                                              |
| SF13 | P9、P11    | 老年用户与子女用户的认证、账号绑定、动态互通。               |
|      |            |                                                              |
|      |            |                                                              |
|      |            |                                                              |
|      |            |                                                              |
...
| 子女用户     |                                                              |
| 平台运维人员 |                                                              |
| 平台签约用户 | 平台签约用户往往掌握一门及以上的技艺，并希望在空闲时间利用技艺创造价值或传播技艺。这类客户的需求恰好可以为有娱乐需求的老人提供服务：一方提供技艺教学，一方学习。这类客户是优质内容的创造者，但不太擅长于互联网应用相关的操作。他们可以在本应用平台上发布课程以及售卖自己的手工制品，使用应用主要用来跟踪课程和手工制品售卖情况及售后。系统界面应尽可能友好。 |
