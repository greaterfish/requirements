...
| -------- | ------------------------------------------------------------ |
| 名称     | 用户生活服务反馈                                             |
| 参与者   | 用户，目的是反馈平台使用过程中碰到的问题<br />平台运维人员，目的是收集用户意见、完善平台功能 |
| 触发条件 | 生活服务板块使用用户选择反馈信息                             |
| 前置条件 | 生活服务板块使用用户已经认证并登录系统                       |
| 后置条件 | 更新生活服务反馈信息                                         |
| 优先级   | 低                                                           |
| 正常流程 | 1. 生活服务板块使用用户选择反馈信息<br />2. 系统显示反馈页面，提示用户填写反馈表格，包括问题类别、问题板块、问题描述<br />3. 用户填写反馈表格，包括问题类别、问题板块、问题描述并选择提交<br />4. 系统更新用户反馈数据并通知平台运维人员 |
| 拓展流程 | 3a. 用户取消提交<br />    1. 用户选择取消<br />	2. 回到正常流程第2步 |
| 业务规则 | 无                                                           |
| 特殊需求 | 无                                                           |
